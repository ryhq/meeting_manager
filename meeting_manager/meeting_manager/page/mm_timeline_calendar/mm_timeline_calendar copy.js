...
frappe.pages['mm-timeline-calendar'].on_page_load = function(wrapper) {
	...
	style.textContent = `
		...
		#mm-timeline-calendar .fc-timeline-slot {
			border-color: var(--fc-border-color);
		}
		...
		#mm-timeline-calendar .fc-timeline-now-indicator-line {
			border-color: #ef4444;
			border-width: 2px;
		}
		...
		@media (max-width: 768px) {
			#mm-timeline-calendar .fc-resourceTimelineDay-button,
			#mm-timeline-calendar .fc-resourceTimelineWeek-button {
				font-size: 11px;
				padding: 4px 8px;
			}
		}
