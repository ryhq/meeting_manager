...
frappe.pages['mm-timeline-calendar'].on_page_load = function(wrapper) {
	...
	style.textContent = `
		...
		/* Freeze time column - stays fixed during horizontal scroll */
		#mm-timeline-calendar .fc-timegrid-axis {
			min-width: 70px;
			width: 70px;
			position: sticky;
		...
		/* Enable horizontal scrolling for calendar content */
		...
		#mm-timeline-calendar .fc-col-header-cell-frame {
